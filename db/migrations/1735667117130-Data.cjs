module.exports = class Data1735667117130 {
    name = 'Data1735667117130'

    async up(db) {
        await db.query(`CREATE TABLE "open_offer" ("id" character varying NOT NULL, "has_sats" numeric NOT NULL, "has_token_commitment" text, "has_token_capability" text, "has_token_amount" numeric, "has_token_id" text, "want_sats" numeric NOT NULL, "want_token_commitment" text, "want_token_capability" text, "want_token_amount" numeric, "want_token_id" text, "fee" numeric NOT NULL, "maker_address" text NOT NULL, "contract_utxo" text NOT NULL, "timestamp" integer NOT NULL, CONSTRAINT "PK_8e010f713e31a92fcd32e000f1d" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "cancelled_offer" ("id" character varying NOT NULL, "has_sats" numeric NOT NULL, "has_token_commitment" text, "has_token_capability" text, "has_token_amount" numeric, "has_token_id" text, "want_sats" numeric NOT NULL, "want_token_commitment" text, "want_token_capability" text, "want_token_amount" numeric, "want_token_id" text, "fee" numeric NOT NULL, "maker_address" text NOT NULL, "contract_utxo" text NOT NULL, "timestamp" integer NOT NULL, "spending_tx" text NOT NULL, CONSTRAINT "PK_86c9ff8e58552404227569b4867" PRIMARY KEY ("id"))`)
